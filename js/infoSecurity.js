new Vue({
    ...
    data: {
        ...
        deviceTxt: [
            ...
            {name: "数据库", id: 1, maxHeight: "", midHeight: "", minHeight: "",},
            {name: "中间件", id: 1, maxHeight: "", midHeight: "", minHeight: "",},
        ],
        leakPercent: "",   //安全漏洞比率
        virusPercent: "",   //病毒数比率
        virusNum: "",   //病毒数
    ...
    methods: {
        ...
        infoSecurity() {
            ...
            this.postAjax(this.updateCheckInfoSecurity(JSON.stringify(data)), (res) => {
                if (res.code = 200 && res.code_desc == "success") {
                    this.initInfo();
