(function ($) {
    ...
    $.fn.circleChart = function (options) {
        const defaults = {
            innerColorStart: '#2ceced',  //内部圆环 渐变色
            innerColorEnd: '#09f797',
            color: "#3459eb",
        ...
        Circle.prototype = {
            ...
            draw(ctx) {
                ...
                var R1 = parseInt(this.settings.size-ctx.lineWidth);
                var gradient = ctx.createLinearGradient(R1*1.5, 0, -R1/40, 0);
                gradient.addColorStop(0, this.settings.innerColorStart);
                gradient.addColorStop(1, this.settings.innerColorEnd);
